...
> **Source**: Adapted from [Anthropic's Agent Skills documentation](https://docs.anthropic.com/en/agents-and-tools/agent-skills/overview). Internal doc links (e.g. `/docs/en/...`) reference pages on docs.anthropic.com. Supplemented with patterns from this repository's own skill development.
